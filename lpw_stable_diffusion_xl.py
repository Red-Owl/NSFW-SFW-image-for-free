...
from diffusers.loaders import FromSingleFileMixin, TextualInversionLoaderMixin, StableDiffusionLoraLoaderMixin
...
class SDXLLongPromptWeightingPipeline(DiffusionPipeline, FromSingleFileMixin, StableDiffusionLoraLoaderMixin):
    r"""
